...
class _RestClient implements RestClient {
  ...
  @override
  Future<HttpResponse<ListResponse<List<OrderMedicineModel>>>>
      getListOrderMedicine({page, limit}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page, r'limit': limit};
    queryParameters.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ListResponse<List<OrderMedicineModel>>>>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/order-medicine-list',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ListResponse<List<OrderMedicineModel>>.fromJson(
        _result.data!,
        (json) => (json as List<dynamic>)
            .map<OrderMedicineModel>(
                (i) => OrderMedicineModel.fromJson(i as Map<String, dynamic>))
            .toList());
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<OrderMedicineModel>> createOrderMedicine(
    ...
    if (isHavePrescription != null) {
      _data.fields
          .add(MapEntry('is_have_prescription', isHavePrescription.toString()));
    }
    if (state != null) {
      _data.fields.add(MapEntry('state', state));
    }
    if (receiverName != null) {
      _data.fields.add(MapEntry('receiver_name', receiverName));
    }
    if (receiverPhone != null) {
      _data.fields.add(MapEntry('receiver_phone', receiverPhone));
    }
    if (paymentType != null) {
    ...
    if (prescriptionImage != null) {
      _data.files.add(MapEntry(
          'prescription_image',
          MultipartFile.fromFileSync(prescriptionImage.path,
              filename:
                  prescriptionImage.path.split(Platform.pathSeparator).last)));
    }
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<OrderMedicineModel>>(
            Options(method: 'POST', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/order-medicine',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = OrderMedicineModel.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<ListResponse<List<OrderModel>>>> getListOder(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ListResponse<List<OrderModel>>>>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/orders',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ListResponse<List<OrderModel>>.fromJson(
        _result.data!,
        (json) => (json as List<dynamic>)
            .map<OrderModel>(
  ...
  Future<HttpResponse<ListResponse<List<ExaminationCardModel>>>>
      getListExaminationCard({page, limit}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'page': page, r'limit': limit};
    queryParameters.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ListResponse<List<ExaminationCardModel>>>>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/examination-card',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ListResponse<List<ExaminationCardModel>>.fromJson(
        _result.data!,
        (json) => (json as List<dynamic>)
            .map<ExaminationCardModel>(
                (i) => ExaminationCardModel.fromJson(i as Map<String, dynamic>))
            .toList());
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  @override
  Future<HttpResponse<dynamic>> registerFCMToken({fcmToken}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _data = FormData();
    if (fcmToken != null) {
      _data.fields.add(MapEntry('registration_id', fcmToken));
    }
    final _result = await _dio.fetch(_setStreamType<HttpResponse<dynamic>>(
        Options(method: 'POST', headers: <String, dynamic>{}, extra: _extra)
            .compose(_dio.options, '/registration-device-token',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = _result.data;
    final httpResponse = HttpResponse(value, _result);
