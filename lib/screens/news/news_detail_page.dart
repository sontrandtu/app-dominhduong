...
class _NewsDetailPageState extends State<NewsDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: PageAppBarComp(title: 'Tin tức - Sự kiện'.toUpperCase()),
                          ...
                          children: [
                            Row(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      CustomNetworkImage(url: viewModel.article?.partnerImageUrl ?? '', width: 50, height: 50, backgroundColor: Colors.grey, isCircle: true, isPlaceholderImage: true),
