          ...
          return Stack(
            children: [
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          selectedIndex == index ? SvgPicture.asset(Res.ic_check_circle, color: Theme.of(context).primaryColor, width: 20) : const SizedBox(height: 0),
                        ]
                      ),
                    ),
                  );
              ...
              Container(
                ...
                child: Text(widget.placeholderText, style: const TextStyle(fontSize: 14, fontFamily: 'RobotoSlab', color: Colors.black, fontWeight: FontWeight.w700)),
              ),
            ],
          );
        }
