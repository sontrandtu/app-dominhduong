  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
          ...
          suffixIcon: widget.obscureText ? GestureDetector(
            ...
            child: Padding(
              ...
              child: SvgPicture.asset(
                _obscureText ? Res.ic_eye_closed_2  : Res.ic_eye,
          ...
          labelStyle: TextStyle(color: Colors.black.withOpacity(0.4), backgroundColor: Colors.transparent, height: 4, fontFamily: 'Roboto', fontSize: 14),
          ...
          filled: true,
          fillColor: widget.enabled! ? Colors.white : Colors.grey.withOpacity(0.1),
      ),
      ...
      style: Theme.of(context).textTheme.bodyText1?.copyWith(color: widget.enabled! ? AppColors.textBlack : Colors.black45, fontSize: 14, fontWeight: FontWeight.w500, fontFamily: 'Roboto'),
